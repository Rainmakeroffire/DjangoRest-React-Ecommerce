  ...
  const deliverHandler = () => {
    ...
    return loading ? (
        ...
        <div>
            ...
            <Row className='order-screen-row'>
                <Col md={8}>
                    <ListGroup variant='flush'>
                        ...
                        {order.is_delivered ? (
                            <Message variant='success'>Delivered on {order.delivered_at.slice(0, 10)}</Message>
                        ) : (
                        ...
                        {order.is_paid ? (
                            <Message variant='success'>Paid on {order.paid_at.slice(0, 10)}</Message>
                        ) : (
                ...
                <Col md={4}>
                    <Card>
                        <ListGroup variant='flush'>
                            ...
                            {!order.is_paid && userInfo?.id === order.user.id && (
                                <ListGroup.Item>
                                    {loadingPay && <Loader />}
