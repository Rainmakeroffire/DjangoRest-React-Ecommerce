...
export const userLoginReducer = (state = {}, action) => {
  ...
  export const passwordResetInitReducer = (state = {}, action) => {
    switch (action.type) {
      case PASSWORD_RESET_INIT_REQUEST:
        return { loading: true };
      case PASSWORD_RESET_INIT_SUCCESS:
        return { loading: false, success: true, message: action.payload };
      case PASSWORD_RESET_INIT_FAIL:
        return { loading: false, error: action.payload };
      case PASSWORD_RESET_INIT_RESET:
        return {};
      default:
        return state;
    }
